...
Valentine = {
    Name = "Valentine",
    Accent      = Color3.fromHex("#FD2748"),
    Dialog      = Color3.fromHex("#A22B43"),
    Outline     = Color3.fromHex("#FF99BB"),
    Text        = Color3.fromHex("#FFF3F8"),
    Placeholder = Color3.fromHex("#FDAEB7"),
    Background  = Color3.fromHex("#851220"),
    Button      = Color3.fromHex("#F74666"),
    Icon        = Color3.fromHex("#FFD6DB"),
},
Horizon = {
    Name = "Horizon",
    Accent = Color3.fromHex("#FEA82F"),
    Dialog = Color3.fromHex("#253655"),
    Outline = Color3.fromHex("#7AA5D2"),
    Text = Color3.fromHex("#F0EDEE"),
    Placeholder = Color3.fromHex("#B4B8C5"),
    Background = Color3.fromHex("#181829"),
    Button = Color3.fromHex("#3A6EA5"),
    Icon = Color3.fromHex("#FFD365"),
},
Vaporwave = {
    Name = "Vaporwave",
    Accent = Color3.fromHex("#FF8AEA"),
    Dialog = Color3.fromHex("#6050DC"),
    Outline = Color3.fromHex("#50FFB1"),
    Text = Color3.fromHex("#F9FFFE"),
    Placeholder = Color3.fromHex("#AD7BE9"),
    Background = Color3.fromHex("#322E4F"),
    Button = Color3.fromHex("#5DFDCB"),
    Icon = Color3.fromHex("#FF61A6"),
},
Envy = {
    Name = "Envy",
    Accent = Color3.fromHex("#1FAA59"),
    Dialog = Color3.fromHex("#132019"),
    Outline = Color3.fromHex("#86FFBD"),
    Text = Color3.fromHex("#E5F9F6"),
    Placeholder = Color3.fromHex("#4EA688"),
    Background = Color3.fromHex("#183D3D"),
    Button = Color3.fromHex("#38B000"),
    Icon = Color3.fromHex("#9EF01A"),
},
Nebula = {
    Name = "Nebula",
    Accent = Color3.fromHex("#9F5FFF"),
    Dialog = Color3.fromHex("#05012A"),
    Outline = Color3.fromHex("#A3CEF1"),
    Text = Color3.fromHex("#F8F7FF"),
    Placeholder = Color3.fromHex("#53599A"),
    Background = Color3.fromHex("#140152"),
